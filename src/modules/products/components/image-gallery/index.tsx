...
const ImageGallery = ({ images }: ImageGalleryProps) => {
  ...
  if (!images || images.length === 0) {
    return (
      <div className="relative w-full aspect-[4/5] overflow-hidden bg-ui-bg-subtle rounded-lg flex items-center justify-center">
        <div className="text-ui-fg-subtle">No hay imágenes disponibles</div>
      </div>
    )
  }
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4 w-full">
      ...
      <div className="order-2 lg:order-1 w-full lg:w-24 flex-shrink-0">
        <div className="flex lg:flex-col gap-3 lg:max-h-[600px] pb-2 lg:pb-0 overflow-x-auto lg:overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
      ...
      {/* Main Image */}
      <div className="order-1 lg:order-2 flex-1 relative w-full">
        {/* Contenedor con tamaño limitado */}
        <div className="relative w-full aspect-[4/5] overflow-hidden bg-ui-bg-subtle rounded-lg group max-w-2xl">
          {/* Loading Overlay */}
          {isLoading && (
