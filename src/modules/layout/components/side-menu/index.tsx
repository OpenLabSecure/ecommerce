          ...
          {({ open, close }) => (
            <>
              <div className="relative flex h-full">
                ...
                >
                  <div className="ml-2 h-[40px] bg-white border-2 rounded-xl flex items-center justify-between px-2.5">
              ...
              >
                <PopoverPanel className="flex flex-col absolute w-full pr-4 sm:pr-0 sm:w-1/3 2xl:w-1/4 sm:min-w-min h-[calc(100vh-1rem)] z-30 inset-x-0 text-sm text-ui-fg-on-color m-2 backdrop-blur-2xl">
                  <div
                    ...
                    className="flex flex-col h-full bg-[rgba(3,7,18,0.5)] md:bg-blue-400 rounded-rounded justify-between p-6"
                  >
                    ...
                    <div className="flex flex-col gap-y-6">
                      ...
                      <Text className="flex justify-between txt-compact-small">
                        © {new Date().getFullYear()} Open lab. All rights
                        reserved.
                      </Text>
                    </div>
                  </div>
